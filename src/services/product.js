app.factory('appProduct', ['$rootScope', '$http', 'appConfig', function($rootScope, $http, appConfig) {
  ...
  function factory(params) {
    ...
    var _create = function(companyData) {
      ...
      return $http.post(appConfig.baseApi + '/products.json?api_token=' + $rootScope.APIToken, data).then(function(response) {
        _getList();
        _data.edit = {};
    ...
    var _update = function(companyData) {
      ...
      return $http.put(appConfig.baseApi + '/products/' + data.id + '.json?api_token=' + $rootScope.APIToken, data).then(function(response) {
        _getList();
        _data.edit = {};
    ...
    var _remove = function(data) {
      ...
      return $http.delete(appConfig.baseApi + '/products/' + data.id + '.json').then(function(response) {
        _getList();
        _data.edit = {};
